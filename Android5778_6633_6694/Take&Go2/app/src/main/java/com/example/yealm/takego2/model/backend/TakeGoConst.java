...
public class TakeGoConst
{
    ...
    {
        public static final String NUMOFINVITATION = "numOfInvitation";
    ...
    public static ContentValues InvitationToContentValues(Invitation invitation)
    {
        ...
        contentValues.put(TakeGoConst.InvitationConst.RENTSTART, invitation.getRentStart().getTime());//.toString());
        contentValues.put(TakeGoConst.InvitationConst.RENTEND, invitation.getRentEnd().getTime());//.toString());
