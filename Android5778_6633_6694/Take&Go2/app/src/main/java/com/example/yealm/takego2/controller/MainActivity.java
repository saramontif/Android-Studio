...
import com.example.yealm.takego2.model.backend.FreeCarReceiver;
import com.example.yealm.takego2.model.backend.FreeCarService;
        ...
        implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    FreeCarReceiver reciver;  //variable for receiver
    String customer_id;
...
//        reciver= new FreeCarReceiver();
//        intent.addAction("INVITATION_SET");
//        Intent serviceIntent=new Intent(getBaseContext(), FreeCarService.class);
...
//        });
       ...
       customer_id = String.valueOf(getIntent().getIntExtra("EXTRA_USER_ID",0));
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item)
    {
        ...
        else if (id == R.id.nav_branches)
        {
            ...
            bundle.putString("current customer", customer_id);
